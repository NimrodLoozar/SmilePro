...
class TreatmentFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'description' => "Patiënt meldt " . $this->faker->randomElement($complaints) . ".\n\n" .
                             ...
                             "Dossier: " . $this->faker->randomElement($procedures) . " uitgevoerd. " .
                             ...
                             "opvolg: " . $this->faker->randomElement(['Controle over 1 week', 'Afrondende behandeling over 2 sessies', 'Telefonische evaluatie morgen']) . "."
        ];
    }
}