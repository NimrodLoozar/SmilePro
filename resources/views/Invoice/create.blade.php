        ...
        <div class="py-12 px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('invoice.store') }}" method="POST" class="space-y-4">
                    ...
                    <!-- Factuurnummer -->
                    <div>
                        <label for="number" class="block text-gray-700 text-sm font-bold mb-2">Factuurnummer:</label>
                    ...
                    <!-- Patiënt -->
                    <div>
                        <label for="patient_id" class="block text-gray-700 text-sm font-bold mb-2">Patiënt:</label>
...
<script>
   ...
   document.getElementById('dataToggle').addEventListener('change', function () {
    ...
    // Fetch the latest invoice number and set it in the hidden input field
