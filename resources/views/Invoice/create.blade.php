            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('invoice.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="patient" id="patient" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4 flex items-center">
                        <div class="w-1/2">
                            ...
                            <select name="appointmentType" id="appointmentType" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        <div class="w-1/2 ml-4">
                            ...
                            <input type="number" name="amount" id="amount" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('invoice.index') }}" class="bg-gray-400 text-white px-4 py-2 rounded-md hover:bg-gray-600">Annuleren</a>
                    </div>
