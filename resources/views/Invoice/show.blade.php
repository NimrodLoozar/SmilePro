<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded p-6">
                ...
                <div class="flex justify-end">
                    <a href="{{ route('invoice.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-green-700">
    ...
    <div id="errorContainer" class="py-12 hidden">
        <p class="text-red-500 text-center">De factuur kon niet worden ingeladen. Probeer het later opnieuw.</p>
    </div>
</x-app-layout>
