                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div class="md:col-span-5">
                                        ...
                                        <select name="patient_id" id="patient_id" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <select name="employee_id" id="employee_id" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <input type="date" name="date" id="date" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-300" />
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="time">Tijd</label>
                                        <input type="time" name="time" id="time" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-300" />
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="comment">Opmerkingen</label>
                                        <textarea name="comment" id="comment" rows="4" class="h-20 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-300" placeholder="Bijv. specifieke klachten of verzoeken"></textarea>
                                    </div>
